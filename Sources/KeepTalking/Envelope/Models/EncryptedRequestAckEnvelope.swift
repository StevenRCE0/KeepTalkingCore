...
public struct KeepTalkingEncryptedRequestAckEnvelope: KeepTalkingEnvelope {
    public static var kind: KeepTalkingEnvelopeKind { .encryptedRequestAck }
...
extension KeepTalkingEnvelopeHandlers {
    public mutating func onEncryptedRequestAck(
        _ handler: @escaping @Sendable (KeepTalkingAsymmetricCipherEnvelope) -> Void
    ) {
        register(KeepTalkingEncryptedRequestAckEnvelope.self) { envelope in
