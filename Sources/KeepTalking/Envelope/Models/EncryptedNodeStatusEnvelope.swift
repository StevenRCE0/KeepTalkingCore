...
public struct KeepTalkingEncryptedNodeStatusEnvelope: KeepTalkingEnvelope {
    public static var kind: KeepTalkingEnvelopeKind { .encryptedNodeStatus }
...
extension KeepTalkingEnvelopeHandlers {
    public mutating func onEncryptedNodeStatus(
        _ handler: @escaping @Sendable (KeepTalkingAsymmetricCipherEnvelope) -> Void
    ) {
        register(KeepTalkingEncryptedNodeStatusEnvelope.self) { envelope in
