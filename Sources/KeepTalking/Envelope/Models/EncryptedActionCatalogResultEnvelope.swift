...
public struct KeepTalkingEncryptedActionCatalogResultEnvelope: KeepTalkingEnvelope {
    public static var kind: KeepTalkingEnvelopeKind { .encryptedActionCatalogResult }
...
extension KeepTalkingEnvelopeHandlers {
    public mutating func onEncryptedActionCatalogResult(
        _ handler: @escaping @Sendable (KeepTalkingAsymmetricCipherEnvelope) -> Void
    ) {
        register(KeepTalkingEncryptedActionCatalogResultEnvelope.self) { envelope in
